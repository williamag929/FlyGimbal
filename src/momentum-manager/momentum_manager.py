...
FLYWHEEL_I          = 1.76e-4   # kg·m²  — rotor moment of inertia
...
KE_MAX = 0.5 * FLYWHEEL_I * (FLYWHEEL_RPM_MAX * 2*math.pi/60)**2   # ~386 J
KE_MIN = 0.5 * FLYWHEEL_I * (FLYWHEEL_RPM_MIN * 2*math.pi/60)**2   # ~24 J
